...
const translations = {
  en: {
    ...
    cli_config_user_agents: "  ~/.deepcode/AGENTS.md    User-level agent instructions",
    cli_config_global_rules: "  ~/.agents/rules/*.md     Global rules (applied to all projects)",
    ...
    cli_tui_thinking_up: "  alt+.            Increase thinking effort (disabled → high → max)",
    cli_tui_thinking_down: "  alt+,            Decrease thinking effort (max → high → disabled)",
    ...
    app_thinking_effort: "Thinking mode: **enabled** · effort: **{0}**",
  ...
  zh: {
    ...
    cli_config_user_agents:
      "  ~/.deepcode/AGENTS.md    \u7528\u6237\u7ea7 Agent \u6307\u4ee4",
    cli_config_global_rules:
      "  ~/.agents/rules/*.md     \u5168\u5c40\u89c4\u5219\uff08\u9002\u7528\u4e8e\u6240\u6709\u9879\u76ee\uff09",
    ...
    cli_tui_thinking_up: "  alt+.            \u63d0\u5347\u601d\u8003\u5f3a\u5ea6\uff08\u5173\u95ed \u2192 high \u2192 max\uff09",
    cli_tui_thinking_down: "  alt+,            \u964d\u4f4e\u601d\u8003\u5f3a\u5ea6\uff08max \u2192 high \u2192 \u5173\u95ed\uff09",
    ...
    app_thinking_effort: "\u601d\u8003\u6a21\u5f0f\uff1a**\u5df2\u5f00\u542f** \u00b7 \u5f3a\u5ea6\uff1a**{0}**",
